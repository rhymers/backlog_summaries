...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { date: @milestone.date, name: @milestone.name } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { date: @milestone.date, name: @milestone.name } }
